...
from src.data_prep.output_league_season_current import (
...
def get_team_and_league_data(league_id):
        ...
        return league_data, manager_information, team_ids, final_gw_finished, season_history, season_current_df, season_history_df


def get_team_and_league_data_filtered_summarised(league_data,manager_information,team_ids,season_current_df,season_history_df,season_start_year):
        ...
        number_of_teams_league=get_number_of_teams_league(
            league_data=league_data
        )
        first_Season_year_data=get_first_Season_year_data(
            df=season_history_df_filtered
        )
        ...
        all_time_table_output=get_all_time_table(
            df=season_history_df_filtered
            )
        ...
        return league_name,league_summary_kpis,seasons_top_three_output,titles_won_summary_output,season_current_df_output,season_history_df_output,all_time_table_output
