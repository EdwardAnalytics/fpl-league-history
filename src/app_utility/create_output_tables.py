...
def get_team_and_league_data_filtered_summarised(
    ...
    return (
        ...
        titles_won_summary_output.head(400),
        season_overview_output.head(400),
        season_current_df_output.head(400),
        season_history_df_output.head(400),
        all_time_table_output.head(400),
    )
